...
NEVA is a demo project. Its replies are generated by an LLM (optionally
grounded in WHO/MoHP protocol excerpts via RAG) and **may be incomplete,
outdated, or wrong** — they are not a substitute for professional medical
advice or emergency services. In a real emergency, always call **102**
(ambulance, Nepal) or your local emergency number first.
